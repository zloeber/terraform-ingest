...
from .models import EmbeddingConfig, TerraformModuleSummary
...
class ClaudeEmbeddingStrategy(EmbeddingStrategy):
    ...
    def embed_text(self, text: str) -> List[float]:
        ...
        try:
            ...
            raise ImportError("voyageai package is required for Claude/Voyage embeddings. Install with: pip install voyageai")
    ...
    def _initialize_embedding_strategy(self) -> Optional[EmbeddingStrategy]:
        ...
        if self.config.strategy == "openai":
            ...
            if not self.config.anthropic_api_key:
                raise ValueError("Anthropic/Voyage API key is required for Claude embeddings")
