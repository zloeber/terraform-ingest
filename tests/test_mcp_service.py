...
def test_mcp_tools_with_empty_directory():
    ...
    from terraform_ingest.mcp_service import _list_repositories_impl, _search_modules_impl
...
def test_mcp_list_repositories_edge_cases(sample_output_dir):
    ...
    empty_repos = _list_repositories_impl(filter="nonexistent", output_dir=sample_output_dir)
...
def test_get_service_singleton():
    ...
    from terraform_ingest.mcp_service import get_service, _service
